...
When run to generate human-readable output, it outputs information as densely as possible without compromising readability.
...
This parameter is present in almost all tests.  It can have two values:
